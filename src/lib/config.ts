export const CLIENT_STATUS_CONFIG = {
  active: { label: 'Active', className: 'text-emerald-800 bg-emerald-100', dotClassName: 'bg-emerald-500' },
  prospect: { label: 'Prospect', className: 'text-blue-800 bg-blue-100', dotClassName: 'bg-blue-500' },
  client: { label: 'Active', className: 'text-emerald-800 bg-emerald-100', dotClassName: 'bg-emerald-500' }, // Alias for active
